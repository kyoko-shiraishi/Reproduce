            ...
            <div class="border-4 border-blue-400 rounded-lg p-4 shadow-md flex items-start">
                <li>
                    <a href="{{ route('post', ['id' => $thread->id]) }}">
                        ...
                        <h3 class="content">内容:</strong> {{ $thread->content }}<br>
                        <h3 class="company">会社名:</strong> {{ $thread->company->name }}<br>
                        <h3 class="product">製品名:</strong> {{ $thread->product->name }}<br>
                        ...
                        @endif
                        <h3 class="comment">コメント数: {{ $thread->posts->count() }}</strong>
                        <h3 class="category">カテゴリ:</strong> {{ $thread->product->category->name ?? '不明' }}<br>
