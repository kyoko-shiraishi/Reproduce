            ...
            <div class="border-4 border-blue-400 rounded-lg p-4 shadow-md flex items-start">
                <li>
                    <a href="{{ route('post', ['id' => $thread->id]) }}">
                        <h3 class="user">ユーザー:</h3> {{ $thread->user->name }}<br>
                        <div>
                            <img src="{{ $thread->image }}" class="responsive-img">
                        </div>
                        <h3 class="content">内容:</h3> {{ $thread->content }}<br>
                        <h3 class="company">会社名:</h3> {{ $thread->company->name }}<br>
                        <h3 class="product">製品名:</h3> {{ $thread->product->name }}<br>
                     ...
                     <div class="yoko">
                        ...
                        <h3 class="category">カテゴリ:</h3> {{ $thread->product->category->name ?? '不明' }}<br>
                        <h3>作成日:</h3> {{ $thread->created_at }}<br>
                        </div>   
                    </a>
