<x-app-layout>
    ...
    <script>
        document.getElementById('company_name').addEventListener('input', function() {
            ...
            const HiraganaCompanyName = wanakana.to_hiragana(companyName);
            const kanaCompanyName = wanakana.to_katakana(companyName);
            const RomajiCompanyName = wanakana.to_romaji(companyName);
